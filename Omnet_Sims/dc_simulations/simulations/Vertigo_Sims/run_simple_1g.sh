...
echo "\n\n-------------------------------------------"
echo "Running DCTCP_overflow_buffer"
...
do_extract dctcp_overflow_buffer
mkdir logs/dctcp_overflow_buffer_sample_1g
cp results/*.out logs/dctcp_overflow_buffer_sample_1g/
